...
export default function AdminEventsPage() {
  ...
  const handleEdit = (ev: Event) => {
    ...
    setForm({ title:ev.title||"",type:ev.type||"",description:ev.description||"",date:ev.date||"",time:ev.time||"",location:ev.location||"",venue_name:ev.venue_name||"",venue_address:ev.venue_address||"",city:ev.city||"",capacity:ev.capacity?.toString()||"",min_age:ev.min_age||"",dress_code:ev.dress_code||"",price:priceVal,currency:currVal,ticket_url:ev.ticket_url||"",free_entry:ev.free_entry||false,reservation_required:ev.reservation_required||false,contact_whatsapp:ev.contact_whatsapp||"",contact_email:ev.contact_email||"",contact_phone:ev.contact_phone||"",contact_instagram:ev.contact_instagram||"",organizer_name:ev.organizer_name||"",tags:ev.tags||"",is_featured:ev.is_featured||false,is_active:ev.is_active!==false });
